...
def AXIS(axis,xlabel=None,ylabel=None,remove_xticks= False,remove_yticks= False,remove_ticks_all = False,tickscolor = "k"):
	plt.setp(axis.get_yticklabels(), rotation='vertical', fontsize=10)#,visible=False)
